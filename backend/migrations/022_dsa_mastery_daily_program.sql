...
BEGIN
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 10, "pattern_slug": "tree-bfs", "when_to_use": "Level-order queue traversal for right-side views, minimum depth, zigzag order.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 11, "pattern_slug": "binary-search-tree", "when_to_use": "Validate, insert, delete, and in-order properties for efficient tree operations.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 12, "pattern_slug": "binary-search-on-answer", "when_to_use": "Search answer space when feasibility predicate is monotonic.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 13, "pattern_slug": "graph-dfs-bfs", "when_to_use": "Connected components, islands, flood fill, unweighted shortest paths.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 14, "pattern_slug": "topological-sort", "when_to_use": "Kahn''s algorithm or DFS post-order for DAG ordering.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 15, "pattern_slug": "union-find-dsu", "when_to_use": "Path compression and rank for dynamic connectivity.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 16, "pattern_slug": "shortest-path", "when_to_use": "Dijkstra, Bellman-Ford, BFS on weighted/unweighted graphs.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 17, "pattern_slug": "dynamic-programming", "when_to_use": "1D, 2D, interval, tree DP, knapsack state transitions.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 18, "pattern_slug": "backtracking", "when_to_use": "Permutations, combinations, N-Queens, constraint satisfaction.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 19, "pattern_slug": "greedy", "when_to_use": "Activity selection, interval scheduling, locally optimal proofs.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    UPDATE entities SET
        ...
        metadata = metadata || '{"track": "dsa", "pattern_order": 20, "pattern_slug": "trie", "when_to_use": "Prefix matching, autocomplete, word search, IP routing.", "benchmark_easy_min": 8, "benchmark_medium_min": 20, "benchmark_hard_min": 35, "source_doc": "dsa_mastery_system.docx"}'::jsonb,
        updated_at = NOW()
    ...
    VALUES ('c000000c-0001-4001-8001-000000000001'::uuid, admin_id, 'learning_course', 'DSA Mastery System',
     '10-week Mid→Senior curriculum from dsa_mastery_system.docx: 20 patterns, 150–200 problems, daily learn/practice/review/mock cycles, STAR mock interviews, and week-by-week benchmarks.', '["dsa"]'::jsonb, 'learning_seed', '{"track": "dsa", "weeks": 10, "target_problems": 200, "program_version": 2}'::jsonb, 'learning', 'active')
    ...
    VALUES ('c000000c-0001-4001-8001-000000000002'::uuid, admin_id, 'learning_topic', '10-Week DSA Roadmap',
     'Phase 1 (W1–2): Two Ptr, HashMap, Prefix, Sliding, BS — 3–4 problems/day. Phase 2 (W3–5): Stack, Heap, Lists, Trees, Graph basics — 4–5/day. Phase 3 (W6–8): Topo, DSU, Dijkstra, DP, Backtrack, Greedy, Trie — morning+evening. Phase 4 (W9–10): timed pairs + full mocks.', '["dsa"]'::jsonb, 'learning_seed', '{"track": "dsa", "phase": "roadmap", "weeks": "1-10", "program_version": 2}'::jsonb, 'learning', 'active')
    ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, content = EXCLUDED.content,
        metadata = entities.metadata || EXCLUDED.metadata, updated_at = NOW();

    INSERT INTO entities (id, user_id, type, title, content, tags, source, metadata, domain, status)
    VALUES ('c000000c-0001-4001-8001-000000000030'::uuid, admin_id, 'learning_topic', 'DSA Mock Interview (STAR)',
     'UNDERSTAND 2–3m → EXAMPLES 2m → APPROACH 3–5m → CODE 15–20m → TEST 3–5m → COMPLEXITY 1m. Timed: 45min/2 problems or 90min/3. No hints. Talk aloud.', '["dsa"]'::jsonb, 'learning_seed', '{"track": "dsa", "phase": "mock", "kind": "mock_framework"}'::jsonb, 'learning', 'active')
    ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, content = EXCLUDED.content,
        metadata = entities.metadata || EXCLUDED.metadata, updated_at = NOW();

    INSERT INTO entities (id, user_id, type, title, content, tags, source, metadata, domain, status)
    VALUES ('c000000c-0001-4001-8001-000000000031'::uuid, admin_id, 'learning_topic', 'DSA Progress Benchmarks',
     'W2: Easy <10min, recognize Two Ptr/Sliding <2min. W5: Medium <25min, 80+ problems. W8: Hard <40min, 130+ problems. W10: 2 Medium in 45min, 160–200 total, 7/10 mock pass rate.', '["dsa"]'::jsonb, 'learning_seed', '{"track": "dsa", "phase": "metrics", "kind": "benchmarks"}'::jsonb, 'learning', 'active')
    ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, content = EXCLUDED.content,
        metadata = entities.metadata || EXCLUDED.metadata, updated_at = NOW();
