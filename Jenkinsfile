                ...
                script {
                    ...
                    withCredentials([
                        ...
                        sh """#!/usr/bin/env bash
                            ...
                            for mig in 003_storage_key_prefix.sql 004_fix_users_email_constraint.sql 005_reading_progress.sql 006_reading_progress_latest_per_story.sql 007_ai_schema.sql 013_fpt_architecture_layers.sql 014_cv_system.sql 015_job_opportunities.sql; do
